...
static void prepareNewDataToSend(void)
{
  ...
  dataToTx[++j] = VALUES.SC_C_to_average.array[0];
  dataToTx[++j] = VALUES.SC_C_to_average.array[1];
  dataToTx[++j] = VALUES.SC_C_to_average.array[2];
  dataToTx[++j] = VALUES.SC_C_to_average.array[3];
  ...
  dataToTx[++j] = VALUES.fc_current_value_to_average.array[0];
  dataToTx[++j] = VALUES.fc_current_value_to_average.array[1];
  dataToTx[++j] = VALUES.fc_current_value_to_average.array[2];
  dataToTx[++j] = VALUES.fc_current_value_to_average.array[3];
  dataToTx[++j] = EOT_BYTE;
  //OBLICZ SUME KONTROLNA
